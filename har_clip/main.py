...
from .train import train_clip_xbm
...
def main():
    ...
    tr["epochs"] = int(tr["epochs"]); tr["fp16"] = bool(tr["fp16"])
    tr["micro_batch_size"] = int(tr.get("micro_batch_size", tr.get("mini_batch_size", 32)))
